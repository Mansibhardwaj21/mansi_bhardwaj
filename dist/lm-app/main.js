...
var AppComponent = /** @class */ (function () {
    function AppComponent(employeeService) {
        ...
        this.title = 'Leave Management Application';
    }
    AppComponent.prototype.getEmployees = function () {
        var _this = this;
        this.employeeService.getEmployees().subscribe(function (data) { return _this.employees = data; }, function (err) { return console.log(err); });
    };
    ...
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_employee_service__WEBPACK_IMPORTED_MODULE_1__["EmployeeService"]]
        }),
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.getEmployees = function () {
        ...
        return this.http.get('http://localhost:8080/MLP204/api/employees');
    };
...
module.exports = __webpack_require__(/*! C:\Users\Hvuser2\workspace\mlp204\webui\lm-app\src\main.ts */"./src/main.ts");
